...
public class {{cookiecutter.project_namespace}}.Widgets.HeaderBar : Hdy.HeaderBar {
    ...
    construct {
        ...
        var preferences_accellabel = new Granite.AccelLabel.from_action_name (
            _("Preferences…"),
            {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFIX + {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFERENCES
        );

        var preferences_menu_item = new Gtk.ModelButton () {
            action_name = {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFIX + {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFERENCES
        };
        ...
        var quit_accellabel = new Granite.AccelLabel.from_action_name (
            _("Quit"),
            {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFIX + {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_QUIT
        );

        var quit_menu_item = new Gtk.ModelButton () {
            action_name = {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_PREFIX + {{cookiecutter.project_namespace}}.Services.ActionManager.ACTION_QUIT
        };
