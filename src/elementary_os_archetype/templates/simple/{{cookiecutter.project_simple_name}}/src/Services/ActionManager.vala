 ...
 */
 ...
 public class {{cookiecutter.project_namespace}}.Services.ActionManager : GLib.Object {
    ...
    public unowned {{cookiecutter.project_namespace}}.Application application { get; construct; }
    ...
    public ActionManager ({{cookiecutter.project_namespace}}.Application application, {{cookiecutter.project_namespace}}.Windows.MainWindow window) {
        Object (
